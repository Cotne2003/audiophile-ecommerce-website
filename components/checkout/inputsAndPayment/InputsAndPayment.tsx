  ...
  return (
    <CheckoutContainer>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <InputsContainer>
            ...
            <div>
              ...
              <StyledInput
                ...
                style={
                  errors.phone?.message ? { outline: "2px solid #FF7979" } : {}
                }
              />
            </div>
          </InputsContainer>
        ...
        <div>
          ...
          <div>
            ...
            <StyledInput
              ...
              style={
                errors.address?.message ? { outline: "2px solid #FF7979" } : {}
              }
            />
          </div>
          <InputsContainerWrapper>
            <InputsContainer>
              <div>
                ...
                <StyledInput
                  ...
                  style={
                    errors.zip?.message ? { outline: "2px solid #FF7979" } : {}
                  }
                />
              </div>
              <div>
                ...
                <StyledInput
                  ...
                  style={
                    errors.city?.message ? { outline: "2px solid #FF7979" } : {}
                  }
                />
              </div>
              <div>
        ...
        <CheckoutBtn style={{ marginTop: "50px" }}>CONTINUE & PAY</CheckoutBtn>
      </form>
    </CheckoutContainer>
  );
};
